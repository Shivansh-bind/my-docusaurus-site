...
flowchart TD
    ...
    %% Node styling
    style A fill:#ec4899,stroke:#ffffff,stroke-width:2px,color:#111827
    style I fill:#22c55e,stroke:#ffffff,stroke-width:2px,color:#111827
    style D fill:#fde047,stroke:#ffffff,stroke-width:2px,color:#111827

    %% Optional: Make all rectangles look consistent
    classDef box fill:#111827,stroke:#60a5fa,stroke-width:2px,color:#ffffff,rx:10,ry:10
