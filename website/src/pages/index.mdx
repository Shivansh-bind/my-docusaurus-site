...
<div className={styles.grid}>
  <div className={styles.card}>
    ...
    <Link to={useBaseUrl('/docs/Semester 2/Computer Programming – II/')} className="button button--primary button--sm">Open</Link>
  </div>

  <div className={styles.card}>
    <h3>🔢 Discrete Mathematics</h3>
    <p>Sets, logic, graphs, and combinatorics.</p>
    <Link to={useBaseUrl('/docs/Semester 2/Discrete Mathematics/')} className="button button--primary button--sm">Open</Link>
  </div>

  <div className={styles.card}>
    <h3>🐧 Linux & Shell Programming</h3>
    <p>Operating systems, shell scripting, and commands.</p>
    <Link to={useBaseUrl('/docs/Semester 2/Linux & Shell Programming/')} className="button button--primary button--sm">Open</Link>
  </div>

  <div className={styles.card}>
    <h3>📊 Statistics</h3>
    <p>Data analysis, probability, and statistical methods.</p>
    <Link to={useBaseUrl('/docs/Semester 2/Statistics/')} className="button button--primary button--sm">Open</Link>
  </div>

  <div className={styles.card}>
    <h3>📝 Functional English</h3>
    <p>Communication skills and technical writing.</p>
    <Link to={useBaseUrl('/docs/Semester 2/Functional English/')} className="button button--primary button--sm">Open</Link>
  </div>

  <div className={styles.card}>
    <h3>✍️ Technical Report Writing</h3>
    <p>Professional documentation and report formatting.</p>
    <Link to={useBaseUrl('/docs/Semester 2/Technical Report Writing/')} className="button button--primary button--sm">Open</Link>
  </div>

  <div className={styles.card}>
    <h3>🎥 Multimedia System</h3>
    <p>Audio, video, graphics, and media technologies.</p>
    <Link to={useBaseUrl('/docs/Semester 2/Multimedia System/')} className="button button--primary button--sm">Open</Link>
  </div>

  <div className={styles.card}>
    <h3>📂 Extras</h3>
    <p>Additional resources and supplementary materials.</p>
    <Link to={useBaseUrl('/docs/Semester 2/extras/')} className="button button--primary button--sm">Open</Link>
  </div>
...
<div className={styles.grid}>
  <div className={styles.card}>
    ...
    <Link to={useBaseUrl('/docs/Semester 1/')} className="button button--secondary button--sm">View Semester 1</Link>
  </div>
</div>
...
<footer className={styles.footer}>
  © {new Date().getFullYear()} Shiwansh Bind & Dhananjay & Rahul Saini BCA(GENERAL) · *Where Study Meets Focus* · Built with ❤️ using Docusaurus
</footer>
